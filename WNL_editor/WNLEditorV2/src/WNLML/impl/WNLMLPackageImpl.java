...
public class WNLMLPackageImpl extends EPackageImpl implements WNLMLPackage {
	 ...
	 * @generated
	 */
	public EAttribute getWNNode_DependReq() {
		return (EAttribute)wnNodeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getPipe_Flowrate() {
	 ...
	 * @generated
	 */
	public EAttribute getContaminant_SuccessProb() {
		return (EAttribute)contaminantEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(wnNodeEClass, WN_NODE__DEPEND_REQ);

		pipeEClass = createEClass(PIPE);
		createEAttribute(pipeEClass, PIPE__STATUS);
		createEAttribute(pipeEClass, PIPE__FLOWRATE);
		...
		createEAttribute(contaminantEClass, CONTAMINANT__SUCCESS_PROB);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getWNNode_DependReq(), ecorePackage.getEString(), "dependReq", null, 0, 1, WNNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPipe_Flowrate(), ecorePackage.getEFloat(), "flowrate", null, 0, 1, Pipe.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPipe_Id(), ecorePackage.getEString(), "id", null, 0, 1, Pipe.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getContaminant_SuccessProb(), ecorePackage.getEFloat(), "successProb", null, 0, 1, Contaminant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
