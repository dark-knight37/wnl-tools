 ...
 * @generated
 */
public class WNLMLShortcutPropertyTester extends PropertyTester {
	...
	*/
	public boolean test(Object receiver, String method, Object[] args, Object expectedValue) {
		...
		if (SHORTCUT_PROPERTY.equals(method)) {
			...
			if (annotation != null) {
				return WaterNetworkEditPart.MODEL_ID.equals(annotation.getDetails().get("modelID")); //$NON-NLS-1$
			}
		}
		return false;
	}
