 ...
 * @generated
 */
public class WaterPumpNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.WaterPumpNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public WaterPumpNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WNLMLParserProvider.getParser(WNLMLElementTypes.WaterPump_2001, getParserElement(),
					WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.WaterPumpNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new WaterPumpLabelFigure();
	}

	/**
	 * @generated
	 */
	public class WaterPumpLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public WaterPumpLabelFigure() {
			this.setText("WaterPump");
		}
