 ...
 * @generated
 */
public class ConjuctionNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.ConjuctionNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ConjuctionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WNLMLParserProvider.getParser(WNLMLElementTypes.Conjuction_2005, getParserElement(),
					WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.ConjuctionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ConjuctionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ConjuctionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ConjuctionLabelFigure() {
			this.setText("Conjuction");
		}
