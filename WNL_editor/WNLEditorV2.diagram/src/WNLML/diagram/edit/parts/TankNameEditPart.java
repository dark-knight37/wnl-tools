 ...
 * @generated
 */
public class TankNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.TankNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TankNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WNLMLParserProvider.getParser(WNLMLElementTypes.Tank_2004, getParserElement(),
					WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.TankNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TankLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TankLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TankLabelFigure() {
			this.setText("Tank");
		}
