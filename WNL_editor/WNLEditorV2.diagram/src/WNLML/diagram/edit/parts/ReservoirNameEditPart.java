 ...
 * @generated
 */
public class ReservoirNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.ReservoirNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ReservoirNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WNLMLParserProvider.getParser(WNLMLElementTypes.Reservoir_2003, getParserElement(),
					WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.ReservoirNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ReservoirLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ReservoirLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ReservoirLabelFigure() {
			this.setText("Reservoir");
		}
