 ...
 * @generated
 */
public class ValveNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.ValveNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ValveNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WNLMLParserProvider.getParser(WNLMLElementTypes.Valve_2002, getParserElement(),
					WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.ValveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ValveLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ValveLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ValveLabelFigure() {
			this.setText("Valve");
		}
