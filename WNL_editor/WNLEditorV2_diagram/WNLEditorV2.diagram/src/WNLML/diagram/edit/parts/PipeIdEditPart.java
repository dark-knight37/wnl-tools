 ...
 * @generated
 */
public class PipeIdEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.PipeIdEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public PipeIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WNLMLParserProvider.getParser(WNLMLElementTypes.Pipe_4001, getParserElement(),
					WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.PipeIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PipeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PipeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PipeLabelFigure() {
			this.setText("Pipe");
		}
