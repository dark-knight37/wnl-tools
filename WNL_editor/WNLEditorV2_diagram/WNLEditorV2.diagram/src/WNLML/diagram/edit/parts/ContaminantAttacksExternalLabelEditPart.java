...
import WNLML.diagram.edit.policies.WNLMLTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ContaminantAttacksExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(WNLMLVisualIDRegistry
				.getType(WNLML.diagram.edit.parts.ContaminantAttacksExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public ContaminantAttacksExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new WNLMLTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WNLMLParserProvider.getParser(WNLMLElementTypes.ContaminantAttacks_4002, getParserElement(),
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, WNLMLEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContaminantAttacksExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContaminantAttacksExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContaminantAttacksExternalLabelFigure() {
			this.setText("ID");
		}
