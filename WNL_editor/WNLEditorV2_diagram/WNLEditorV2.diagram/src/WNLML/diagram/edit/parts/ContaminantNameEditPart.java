 ...
 * @generated
 */
public class ContaminantNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.ContaminantNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ContaminantNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WNLMLParserProvider.getParser(WNLMLElementTypes.Contaminant_2006, getParserElement(),
					WNLMLVisualIDRegistry.getType(WNLML.diagram.edit.parts.ContaminantNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContaminantLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContaminantLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContaminantLabelFigure() {
			this.setText("Contaminant");
		}
