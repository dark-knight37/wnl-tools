 ...
 * @generated
 */
public class ContaminantItemSemanticEditPolicy extends WNLMLBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ContaminantItemSemanticEditPolicy() {
		super(WNLMLElementTypes.Contaminant_2006);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WNLMLVisualIDRegistry.getVisualID(outgoingLink) == ContaminantAttacksEditPart.VISUAL_ID) {
