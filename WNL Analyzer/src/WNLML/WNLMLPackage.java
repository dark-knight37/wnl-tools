...
public interface WNLMLPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Depend Req</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WN_NODE__DEPEND_REQ = 3;
	 ...
	 * @ordered
	 */
	int CONTAMINANT__SUCCESS_PROB = 4;
	 ...
	 * @ordered
	 */
	int CONTAMINANT_FEATURE_COUNT = 5;
	 ...
	 * @ordered
	 */
	int WATER_PUMP__DEPEND_REQ = WN_NODE__DEPEND_REQ;
	 ...
	 * @ordered
	 */
	int VALVE__DEPEND_REQ = WN_NODE__DEPEND_REQ;
	 ...
	 * @ordered
	 */
	int RESERVOIR__DEPEND_REQ = WN_NODE__DEPEND_REQ;
	 ...
	 * @ordered
	 */
	int TANK__DEPEND_REQ = WN_NODE__DEPEND_REQ;
	 ...
	 * @ordered
	 */
	int CONJUCTION__DEPEND_REQ = WN_NODE__DEPEND_REQ;
	...
	/**
	 * Returns the meta object for the attribute '{@link WNLML.WNNode#getDependReq <em>Depend Req</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Depend Req</em>'.
	 * @see WNLML.WNNode#getDependReq()
	 * @see #getWNNode()
	 * @generated
	 */
	EAttribute getWNNode_DependReq();
	...
	/**
	 * Returns the meta object for the attribute '{@link WNLML.Contaminant#getSuccessProb <em>Success Prob</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Success Prob</em>'.
	 * @see WNLML.Contaminant#getSuccessProb()
	 * @see #getContaminant()
	 * @generated
	 */
	EAttribute getContaminant_SuccessProb();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Depend Req</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute WN_NODE__DEPEND_REQ = eINSTANCE.getWNNode_DependReq();
		 ...
		 * @generated
		 */
		EAttribute CONTAMINANT__SUCCESS_PROB = eINSTANCE.getContaminant_SuccessProb();
